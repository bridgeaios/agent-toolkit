...
Convert external content (HTML, Markdown) into Portable Text for Sanity. Two main approaches:

1. **`htmlToBlocks`** — Parse HTML into PT blocks using `@portabletext/block-tools`
2. **Manual construction** — Build PT blocks directly from any source (Markdown, APIs, etc.)
...
- **Markdown → Portable Text**: `rules/markdown-to-pt.md` — via HTML intermediate or direct construction
